# Pre-training meta-GamutMLP (23KB) on 100 512x512 ProPhoto images in the train dataset.
...
if __name__ == "__main__":
    ...
    with open(f'{folder_name}/meta-mlp-pretrain-23KB-100im.txt', 'w') as f:
        f.write(f'total training time to pre-train GamutMLP (23KB) on 100 images: {total_train_time}\n')
    f.close()
    
    # save the model to a checkpoint for future loading
    torch.save(net.state_dict(), 'meta-mlp_state_dict-100.pt')