...
from model import GamutMLP_128HF_137KB
...
if __name__ == "__main__":
    ...
    for img_path in image_paths:
        ...
        # build network
        net = GamutMLP_128HF_137KB().to(device)
    ...
    with open(f'{folder_name}/mlp-137KB-experiment.txt', 'w') as f:
