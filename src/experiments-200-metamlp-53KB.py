...
# reproduce Table 1 for meta MLP (53KB)+enc
...
if __name__ == "__main__":
    ...
    for img_path in image_paths:
        ...
        checkpoint = torch.load('src/meta-mlp_state_dict_53KB-100.pt')       # <<< MODIFIED: load from a checkpoint
        ...
        curr_path = os.getcwd()
        folder_name = 'restored/meta-mlp53'
    ...
    with open(f'{folder_name}/meta-mlp-53KB-experiment.txt', 'w') as f:
